...
<div class="container p-0 w-100 m-15 rounded shadow bg-white d-flex justify-content-center align-items-stretch" >
  <div class="bg-white col-7" style="left:0%;padding:20px;">
    ...
    <div style="margin-left: -10%; padding:20px;">
      ...
      <form method="post" id="form-inscription" action="" class="col-10 p-0">
        <div class="form-group m-0">
          <label for="formGroupExampleInput" class="m-0">Prénom</label>
          <input type="text" id="prenom" name="prenom" class="form-control" error="error_prenom" placeholder="Entrez votre prénom" style="height: 34px;margin:5px">
          <small class="text-danger" style="margin-left:15px;" id="error_prenom"></small>
        </div>
        <div class="form-group m-0">
          <label for="formGroupExampleInput2" class="m-0">Nom</label>
          <input type="text" name="nom" error="error_nom" id="nom" class="form-control" placeholder="Entrez votre nom" style="height: 34px;margin:5px">
          <small class="text-danger" id="error_nom" style="margin-left:15px;"></small>
        </div>
        <div class="form-group m-0">
          <label for="formGroupExampleInput" class="m-0">Login</label>
          <input type="text" name="pseudo" error="error_login" id="pseudo" class="form-control "  placeholder="Entrez votre login" style="height: 34px;margin:5px">
        ...
        <div class="form-group m-0">
          ...
          <input type="password" name="password" error="error_password" class="form-control" id="password" placeholder="Entrez votre password" style="height: 34px;margin:5px">
        ...
        <div class="form-group">
          ...
          <input type="password" name="confirmPassword" error="error_confirm" id="confirmPassword" class="form-control"  placeholder="Confirmez votre password" style="height: 34px;margin:5px">
        ...
        <div class="w-100 d-block">
          ...
          <label class="btn btn-default btn-file text-white" style="border:solid 0px; background-color:#51bfd0;">
            choisir un Avatar <input type="file" style="display: none;" name="imgUser">
          </label>
  ...
  <div class="bg-white col-4 pt-4">
    <div class="container rounded-circle" style="height: 150px; width: 150px; border:solid #51bfd0; border-width: 2px;">
      <img id="avatar" class="rounded-circle" src="" alt="" >
    </div>
